				...
				<div id="bottom-footer">
				    <div class="layout-wrap container">
                       <div id="footer-logo" class="five-col">
                         <p><?php echo esc_textarea(get_theme_mod( 'sanasar_footer_top' )); ?></p> 
                       </div>
					 <!-- Footer Menu -->  
					...
					<div id="footer-copyright">
                      <p class="vsmall"><span class="alignleft">&copy; <?php echo date("Y") ?> <?php bloginfo('name'); ?>. <?php _e('All Rights Reserved.', 'sanasar'); ?></span>
                     
                       <span class="alignright "> <?php if(is_home() AND !is_paged()) { ?><a href="http://webloggerz.com/sanasar-wordpress-theme/" >Sanasar</a> Theme <?php }  
					   else { ?> Sanasar Theme. <?php } _e('Powered by', 'sanasar'); ?> <a href="http://wordpress.org/">WordPress</a>.</span></p>
                    </div>
                    </div>
                </div><!-- end #inner-footer -->
			</footer> <!-- end footer -->
        <div id="gototop"><?php _e('Scroll To Top' , 'sanasar'); ?></div>
