<?php get_header(); ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('item-list mbottom'); ?>>
        ...
        <div class="cdetail">
        <div class="postmeta">
       		    <p class="vsmall pnone">by  <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) )?>" title="<?php sprintf( esc_attr__( 'View all posts by %s', 'sanasar' ), get_the_author() ) ?>"><?php echo get_the_author() ?> </a>
...
<?php endwhile; ?>
    <div class="pagenavi alignright">
	    <?php if ($wp_query->max_num_pages > 1) sanasar_wp_pagination(); ?>
